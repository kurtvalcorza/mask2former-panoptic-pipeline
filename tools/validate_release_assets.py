...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    189_998_883: "adapted artifact total from the local CPU pre-flight run (release-verification.md)",
    190_172_069: "upstream pytorch_model.bin of facebook/mask2former-swin-tiny-coco-panoptic at df6b114",
}
